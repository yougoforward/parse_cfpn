...
python -m experiments.segmentation.train --dataset citys \
    --model cfpn_gsf --aux --base-size 1024 --crop-size 769 \
    --backbone resnet101 --checkname cfpn_gsf_res101_citys --batch-size 8 --lr 0.003  --epochs 180 --resume experiments/segmentation/runs/citys/cfpn_gsf/cfpn_gsf_res101_citys/model_best.pth.tar
